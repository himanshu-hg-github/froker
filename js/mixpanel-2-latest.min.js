  ...
  (function () {
    function Aa() {
      ...
      if (t.addEventListener)
        "complete" === t.readyState
          ? a()
          : t.addEventListener("DOMContentLoaded", a, D);
    ...
    function S(a, b, d) {
      ...
      if (h && 0 === ca) f = h;
        ...
        if (h && !c.isArray(h)) {
          o.error("You have already initialized " + d);
          return;
        }
        f = new e();
      }
    ...
    function q(a) {
      ...
      if ("cookie" !== b && "localStorage" !== b)
        o.A("Unknown persistence type " + b + "; falling back to cookie"),
    ...
    function C(a, b) {
      this.J = b.J;
      this.ba = new G(a, { J: c.bind(this.h, this), j: b.j });
      this.B = b.B;
      this.Zc = b.$c;
      this.la = b.la;
      this.jd = b.kd;
      this.D = this.B.batch_size;
      this.pa = this.B.batch_flush_interval_ms;
      this.va = !this.B.batch_autostart;
      this.Ja = 0;
      this.G = {};
    }
    function na(a, b) {
    ...
    function G(a, b) {
      ...
      this.h = b.J || c.bind(pa.error, pa);
      this.Xa = new qa(a, { j: this.j });
      this.ua = b.ua || r;
      this.H = [];
    }
    function qa(a, b) {
    ...
    function ga(a) {
      return { log: ha(o.log, a), error: ha(o.error, a), A: ha(o.A, a) };
    }
    function ha(a, b) {
      return function () {
    ...
    function La(a, b) {
      b = b || {};
      V(b).remove(W(a, b), !!b.xb, b.vb);
    }
    function V(a) {
      a = a || {};
      return "localStorage" === a.Qb ? c.localStorage : c.cookie;
    }
    function W(a, b) {
      b = b || {};
      return (b.Pb || Ma) + a;
    ...
    function sa(a, b, d) {
      !c.Wa(b) || !b.length
        ...
        : ((d = d || {}),
          ...
          d.o && a && d.o(d.pd || "$opt_in", d.qd, { send_immediately: m }));
    }
    function ia(a, b) {
      return function () {
        var d = D;
        try {
          var c = b.call(this, "token"),
            ...
            v = b.call(this, "opt_out_tracking_cookie_prefix"),
            i = b.call(this, "window");
          c && (d = ta(c, { Fb: h, Qb: g, Pb: v, window: i }));
        } catch (e) {
          o.error(
    ...
    var A = Array.prototype,
      ...
      o = {
        ...
        warn: function () {
          if (J && !c.g(y) && y) {
            var a = ["Mixpanel warning:"].concat(c.O(arguments));
            try {
              y.warn.apply(y, a);
            } catch (b) {
              c.a(a, function (a) {
    ...
    c.Ma = function (a) {
      c.a(a, function (b, d) {
        c.Mc(b) ? (a[d] = c.Fc(b)) : c.e(b) && (a[d] = c.Ma(b));
      });
      return a;
    };
          ...
          switch (typeof s) {
            ...
            case "object":
              ...
              if ("[object Array]" === Q.apply(s)) {
                i = s.length;
                for (v = 0; v < i; v += 1) p[v] = b(v, s) || "null";
                return (i =
                  0 === p.length
                    ? "[]"
                    : g
            ...
            a: {
              ...
              if ("{" === i) {
                ...
                for (; i; ) {
                  ...
                  b();
                  h(":");
                  Object.hasOwnProperty.call(k, v) &&
                    g('Duplicate key "' + v + '"');
                  k[v] = s();
                  b();
                  if ("}" === i) {
    ...
    c.xd = function (a) {
      ...
      for (g = 0; g < h; g++) {
        ...
        i !== r &&
          (f > c && (b += a.substring(c, f)), (b += i), (c = f = g + 1));
      }
    ...
    c.ib = (function () {
      ...
      function b() {
        var a = 1 * new Date(),
          b;
        if (n.performance && n.performance.now) b = n.performance.now();
    ...
    c.Ib = function (a) {
      var b,
        a = a.toLowerCase();
      for (b = 0; b < ya.length; b++) if (-1 !== a.indexOf(ya[b])) return m;
      return D;
    };
    c.nc = function (a) {
      var b,
    ...
    c.Qa = function (a, b) {
      ...
      try {
        ...
        o.error("Skipping decoding for malformed query param: " + c);
      }
      return c.replace(/\+/g, " ");
    };
    c.cookie = {
      ...
      parse: function (a) {
        var b;
        try {
          b = c.S(c.cookie.get(a)) || {};
        } catch (d) {}
        return b;
      },
      Dd: function (a, b, c, f, h, g, e) {
        var i = "",
          k = "",
          p = "";
        e
          ? (i = "; domain=" + e)
          : f && (i = (i = ra(t.location.hostname)) ? "; domain=." + i : "");
        c &&
          ((k = new Date()),
        ...
        h && (p += "; secure");
        t.cookie = a + "=" + encodeURIComponent(b) + k + "; path=/" + i + p;
      },
    ...
    c.localStorage = {
      sa: function (a) {
        (a = U(r, a)) ||
          o.error("localStorage unsupported; falling back to cookie store");
        return a;
      },
      error: function (a) {
        o.error("localStorage error: " + a);
      },
      get: function (a) {
        try {
      ...
      parse: function (a) {
        try {
          return c.S(c.localStorage.get(a)) || {};
        } catch (b) {}
        return r;
      },
      set: function (a, b) {
    ...
    c.Tb = (function () {
      ...
      return function (b, c, h, g, e) {
        b
          ...
          : o.error("No valid element provided to register_event");
      };
    })();
    var Na = /^(\w*)\[(\w+)([=~\|\^\$\*]?)=?"?([^\]"]*)"?\]$/;
    c.Cc = (function () {
          ...
          if (
            ...
            switch (B) {
              ...
              case "$":
                B = function (a) {
                  return (
                    a.getAttribute(j).lastIndexOf(n) ==
                    a.getAttribute(j).length - n.length
                  );
                };
                break;
              case "*":
      ...
      var d = /[\t\r\n]/g;
      return function (a) {
        return c.Nc(a) ? [a] : c.e(a) && !c.g(a.length) ? a : b.call(this, a);
      };
    })();
    var Oa = [
        "utm_source",
    ...
    c.info = {
      ...
      Oc: function () {
        return c.extend(c.info.Y(), c.info.ub());
      },
      Wc: function (a) {
      ...
      aa: function (a) {
        ...
        return c.extend(
          c.fa({
            ...
            $referrer: t.referrer,
            $referring_domain: c.info.Sb(t.referrer),
            $device: c.info.Bb(z),
          }),
          {
      ...
      Sc: function () {
        return c.extend(
          c.fa({ $os: c.info.Nb(), $browser: c.info.ma(z, I.vendor, Y) }),
          { $browser_version: c.info.Ia(z, I.vendor, Y) }
        );
      },
      Pc: function () {
        return c.fa({
          current_page_title: t.title,
    ...
    E.prototype.o = function (a, b, d, f) {
      var h = this,
        g = c.Cc(a);
      if (0 === g.length)
        o.error("The DOM query (" + a + ") returned 0 elements");
      else
        return (
          c.a(
            g,
            function (a) {
              c.Tb(a, this.Ob, function (a) {
                var c = {},
                  g = h.oa(d, this),
                  e = h.Kb.c("track_links_timeout");
                h.Oa(a, this, c);
                window.setTimeout(h.gc(f, g, c, m), e);
                h.Kb.o(b, g, h.gc(f, g, c));
              });
            },
            this
          ),
    ...
    E.prototype.gc = function (a, b, c, f) {
      var f = f || D,
        h = this;
      return function () {
        if (!c.zc) (c.zc = m), (a && a(f, b) === D) || h.Ga(b, c, f);
      };
    };
    ...
    M.prototype.oa = function (a, b) {
      var c = M.md.oa.apply(this, arguments);
      if (b.href) c.url = b.href;
      return c;
    };
    M.prototype.Oa = function (a, b, c) {
      c.Lb = 2 === a.which || a.metaKey || a.ctrlKey || "_blank" === b.target;
      c.href = b.href;
      c.Lb || a.preventDefault();
    };
    ...
    var Qa = ga("lock");
    qa.prototype.hb = function (a, b, c) {
      function f() {
        j.setItem(o, "1");
        try {
          a();
      ...
      var f = c.bind(function () {
        ...
        try {
          var c = this.da(),
            c = oa(c, d);
          if ((b = this.$a(c)))
            for (var c = this.da(), f = 0; f < c.length; f++) {
              var e = c[f];
              if (e.id && d[e.id])
    ...
    G.prototype.$a = function (a) {
      try {
        return this.j.setItem(this.N, $(a)), m;
      } catch (b) {
    ...
    C.prototype.stop = function () {
      this.va = m;
      if (this.cb) clearTimeout(this.cb), (this.cb = r);
    };
    ...
    C.prototype.ea = function () {
      this.Xb(this.B.batch_flush_interval_ms);
    };
    C.prototype.Xb = function (a) {
      this.pa = a;
      if (!this.va) this.cb = setTimeout(c.bind(this.flush, this), this.pa);
    };
    C.prototype.flush = function (a) {
      try {
        if (this.Vb) R.log("Flush: Request already in progress");
        else {
          var a = a || {},
            b = this.B.batch_request_timeout_ms,
            d = new Date().getTime(),
            f = this.D,
            h = this.ba.Ec(f),
            e = [],
            ...
            var i = c.bind(function (e) {
                ...
                try {
                  ...
                  if (a.ic) this.ba.vd(v);
                    ...
                    this.Xb(i);
                  } else if (c.e(e) && e.R && 413 === e.R.status)
                    if (1 < h.length) {
                      var p = Math.max(1, Math.floor(f / 2));
                      this.D = Math.min(this.D, p, h.length - 1);
                      this.h("413 response; reducing batch size to " + this.D);
                      this.ea();
                    } else
                  ...
                  this.h("Error handling API response", n), this.ea();
                }
              }, this),
              k = { method: "POST", mc: m, Jc: m, fc: b };
            if (a.ic) k.fb = "sendBeacon";
            R.log("MIXPANEL REQUEST:", e);
            this.Zc(e, k, i);
          }
        }
      } catch (j) {
        this.h("Error flushing request queue", j), this.ea();
      }
    };
    C.prototype.h = function (a, b) {
      ...
      if (this.J)
        try {
          b instanceof Error || (b = Error(a)), this.J(a, b);
        } catch (c) {
          R.error(c);
        }
    };
      ...
      return this.d.Fa(
        {
          type: "groups",
          data: c.Ma(a),
          F: this.p("api_host") + "/" + this.p("api_routes").groups,
          Ha: this.d.u.Ra,
        },
        b
      );
    ...
    u.prototype.set_once = u.prototype.M;
    ...
    j.prototype.X = function (a) {
      this.d = a;
    };
    j.prototype.set = H(function (a, b, d) {
      var f = this.Zb(a, b);
      c.e(a) && (d = b);
      this.p("save_referrer") && this.d.persistence.gb(document.referrer);
      f.$set = c.extend({}, c.info.Sc(), f.$set);
      return this.k(f, d);
    });
    j.prototype.M = H(function (a, b, d) {
      var f = this.bc(a, b);
      c.e(a) && (d = b);
      return this.k(f, d);
    });
    ...
    j.prototype.Gb = H(function (a, b, d) {
      var f = {},
        e = {};
      c.e(a)
        ? (c.a(
    ...
    j.prototype.append = H(function (a, b, d) {
      c.e(a) && (d = b);
      return this.k(this.xc(a, b), d);
    });
    j.prototype.remove = H(function (a, b, d) {
      c.e(a) && (d = b);
      return this.k(this.Ub(a, b), d);
    });
    j.prototype.ga = H(function (a, b, d) {
      c.e(a) && (d = b);
      return this.k(this.hc(a, b), d);
    });
    j.prototype.rd = H(function (a, b, d) {
      if (!c.Jb(a) && ((a = parseFloat(a)), isNaN(a))) {
        o.error(
    ...
    j.prototype.Ab = function () {
      if (this.Da()) return this.k({ $delete: this.d.L() });
      o.error(
        ...
        : this.d.Fa(
            {
              type: "people",
              data: d,
              F: this.p("api_host") + "/" + this.p("api_routes").engage,
              Ha: this.d.u.Za,
            },
            b
          );
    ...
    j.prototype.rc = function (a) {
      "$set" in a
        ...
        : o.error("Invalid call to _enqueue():", a);
    };
    j.prototype.V = function (a, b, d, f) {
      var e = this,
        g = c.extend({}, this.d.persistence.$(a)),
        j = g;
      !c.g(g) &&
        c.e(g) &&
        !c.ra(g) &&
    ...
    j.prototype.sc = function (a, b, d, f, e, g, j) {
      var i = this;
      this.V("$set", this.set, a);
      this.V("$set_once", this.M, f);
      this.V("$unset", this.wa, g, function (a) {
        return c.keys(a);
      });
      this.V("$add", this.Gb, b);
      this.V("$union", this.ga, e);
      a = this.d.persistence.$("$append");
    ...
    j.prototype.set_once = j.prototype.M;
    j.prototype.unset = j.prototype.wa;
    j.prototype.increment = j.prototype.Gb;
    j.prototype.append = j.prototype.append;
    j.prototype.remove = j.prototype.remove;
    j.prototype.union = j.prototype.ga;
    j.prototype.track_charge = j.prototype.rd;
    j.prototype.clear_charges = j.prototype.sb;
    j.prototype.delete_user = j.prototype.Ab;
    ...
    q.prototype.w = function (a, b, d) {
      return c.e(a)
        ? ("undefined" === typeof b && (b = "None"),
          (this.Pa = "undefined" === typeof d ? this.zb : d),
          this.load(),
          c.a(
            a,
            function (a, c) {
    ...
    q.prototype.m = function (a, b) {
      return c.e(a)
        ? ((this.Pa = "undefined" === typeof b ? this.zb : b),
          this.load(),
      ...
      this.w(
        {
          ...
          $initial_referring_domain: c.info.Sb(a) || "$direct",
        },
        ""
      );
    };
    ...
    q.prototype.kc = function (a) {
      this.zb = this.Pa = a.cookie_expiration;
      this.ac(a.disable_persistence);
      this.bd(a.cookie_domain);
      this.cd(a.cross_site_cookie);
      this.dd(a.cross_subdomain_cookie);
      this.gd(a.secure_cookie);
    };
    ...
    q.prototype.cd = function (a) {
      if (a !== this.yb) (this.yb = a), this.remove(), this.save();
    };
    q.prototype.dd = function (a) {
    ...
    q.prototype.gd = function (a) {
      if (a !== this.Yb) (this.Yb = a ? m : D), this.remove(), this.save();
    };
    q.prototype.q = function (a, b) {
      ...
      "__mps" === d
        ...
        : "__mpap" === d && (n.push(f), this.v("$unset", f));
    ...
    var ca,
      x,
      O = n.XMLHttpRequest && "withCredentials" in new XMLHttpRequest(),
    ...
    e.prototype.X = function (a, b, d) {
      b = b || {};
      this.__loaded = m;
      this.config = {};
      var f = {};
      "api_payload_format" in b ||
        ((b.api_host || za.api_host).match(/\.mixpanel\.com/) &&
      ...
      this.za = [];
      this.xa = [];
      this.U = { disable_all_events: D, identify_called: D };
      this.u = {};
      if ((this.T = this.c("batch_requests")))
        if (!c.localStorage.sa(m) || !O)
          (this.T = D),
            o.log(
              "Turning off Mixpanel request-queueing; needs XHR and localStorage support"
            ),
            c.a(this.Cb(), function (a) {
              o.log("Clearing batch queue " + a.ca);
              c.localStorage.remove(a.ca);
            });
        else if ((this.Kc(), ba && n.addEventListener)) {
          var e = c.bind(function () {
            this.u.K.va || this.u.K.flush({ ic: m });
          }, this);
          n.addEventListener("pagehide", function (a) {
            a.persisted && e();
          });
          n.addEventListener("visibilitychange", function () {
            "hidden" === t.visibilityState && e();
          });
        }
      ...
      this.tc();
      a = c.ib();
      this.L() || this.w({ distinct_id: "$device:" + a, $device_id: a }, "");
      (a = this.c("track_pageview")) && this.uc(a);
      0 < this.c("record_sessions_percent") &&
        100 * Math.random() <= this.c("record_sessions_percent") &&
        this.dc();
    };
    e.prototype.dc = K(function () {
      if (n.MutationObserver) {
        var a = c.bind(function () {
          this.I = this.I || new n.__mp_recorder(this);
          this.I.startRecording();
        }, this);
        if (c.g(n.__mp_recorder)) {
          var b = t.createElement("script");
          b.type = "text/javascript";
          b.async = m;
          b.onload = a;
          b.src = this.c("recorder_src");
          t.head.appendChild(b);
        } else a();
      } else o.A("Browser does not support MutationObserver; skipping session recording");
    });
    e.prototype.ld = function () {
      this.I
        ? this.I.stopRecording()
        : o.A("Session recorder module not loaded");
    };
    e.prototype.Db = function () {
      var a = {};
      if (this.I) {
        var b = this.I.replayId;
        b && (a.$mp_replay_id = b);
      }
      return a;
    };
    e.prototype.ka = function () {
      this.c("loaded")(this);
      this.qb();
      this.people.M(this.persistence.Ic());
    ...
    e.prototype.qb = function () {
      this.persistence.lc(t.referrer);
      this.c("store_google") &&
        !this.c("stop_utm_persistence") &&
        this.m(c.info.Y());
      this.c("save_referrer") && this.persistence.gb(t.referrer);
    };
    ...
    e.prototype.uc = function (a) {
      ...
      this.eb() && (b = c.info.La());
      if (
        c.Ta(["full-url", "url-with-path-and-query-string", "url-with-path"], a)
      ) {
        ...
        var d = n.history.pushState;
        if ("function" === typeof d)
          n.history.pushState = function (a, b, c) {
            d.call(n.history, a, b, c);
            n.dispatchEvent(new Event("mp_locationchange"));
          };
        var f = n.history.replaceState;
        if ("function" === typeof f)
          n.history.replaceState = function (a, b, c) {
            f.call(n.history, a, b, c);
            n.dispatchEvent(new Event("mp_locationchange"));
          };
        n.addEventListener(
          "mp_locationchange",
    ...
    e.prototype.k = function (a, b, d, f) {
      ...
      var g = {
          ...
          fb: this.c("api_transport"),
          mc: this.c("verbose"),
        },
        j = r;
      if (!f && (c.Va(d) || "string" === typeof d)) (f = d), (d = r);
      d = c.extend(g, d || {});
      if (!O) d.method = "GET";
      var g = "POST" === d.method,
        i = ba && g && "sendbeacon" === d.fb.toLowerCase(),
        k = d.mc;
      b.verbose && (k = m);
      ...
      var a = a + ("?" + c.nc(b)),
        p = this;
      if ("img" in b)
        (j = t.createElement("img")), (j.src = a), t.body.appendChild(j);
      else if (i) {
        try {
          e = ba(a, j);
        } catch (n) {
        ...
        try {
          ...
          if (d.fc && "undefined" !== typeof o.timeout) {
            o.timeout = d.fc;
              ...
              if (200 === o.status) {
                if (f)
                  if (k) {
                    var a;
                    try {
                      a = c.S(o.responseText);
                    } catch (b) {
                      if ((p.l(b), d.Jc)) a = o.responseText;
                      else return;
                    }
                    f(a);
                  } else f(Number(o.responseText));
              } else
                (a =
                  o.timeout &&
                  !o.status &&
                  new Date().getTime() - x >= o.timeout
                    ? "timeout"
                    : "Bad HTTP status: " + o.status + " " + o.statusText),
                  p.l(a),
                  f && (k ? f({ status: 0, error: a, R: o }) : f(0));
          };
          o.send(j);
        } catch (y) {
          p.l(y), (e = D);
        ...
        (j = t.createElement("script")),
          ...
          (j.defer = m),
          (j.src = a),
          (u = t.getElementsByTagName("script")[0]),
    ...
    e.prototype.Cb = function () {
      ...
      return (this.jb = this.jb || {
        K: { type: "events", F: "/" + b.track, ca: a + "_ev" },
        Za: { type: "people", F: "/" + b.engage, ca: a + "_pp" },
        Ra: { type: "groups", F: "/" + b.groups, ca: a + "_gr" },
      });
    };
    e.prototype.Kc = function () {
      if (!this.rb()) {
        var a = c.bind(function (a) {
            return new C(a.ca, {
              B: this.config,
              $c: c.bind(function (b, c, e) {
                this.k(this.c("api_host") + a.F, this.lb(b), c, this.nb(e, b));
              }, this),
              la: c.bind(function (b) {
                return this.pb("before_send_" + a.type, b);
              }, this),
              J: this.c("error_reporter"),
              kd: c.bind(this.bb, this),
            });
          }, this),
          b = this.Cb();
        this.u = { K: a(b.K), Za: a(b.Za), Ra: a(b.Ra) };
      }
      this.c("batch_autostart") && this.ab();
    };
    ...
    e.prototype.lb = function (a) {
      a = c.ha(a);
      "base64" === this.c("api_payload_format") && (a = c.yc(a));
      return { data: a };
    };
    e.prototype.Fa = function (a, b) {
      var d = c.truncate(a.data, 255),
        ...
        i = m,
        k = c.bind(function () {
          j.cc || (d = this.pb("before_send_" + a.type, d));
          return d
            ? (o.log("MIXPANEL REQUEST:"),
              o.log(d),
              this.k(e, this.lb(d), j, this.nb(b, d)))
            : r;
        }, this);
      this.T && !g
        ? h.Na(d, function (a) {
    ...
    e.prototype.o = K(function (a, b, d, e) {
      ...
      else if (this.mb(a)) e(0);
      else {
        b = c.extend({}, b);
        b.token = this.c("token");
        var g = this.persistence.Uc(a);
        c.g(g) ||
          (b.$duration = parseFloat(
            ((new Date().getTime() - g) / 1e3).toFixed(3)
          ));
        this.qb();
        g = this.c("track_marketing") ? c.info.Oc() : {};
        b = c.extend(
          {},
          c.info.aa({ mp_loader: this.c("mp_loader") }),
          g,
          this.persistence.aa(),
          this.P,
          this.Db(),
        ...
        return this.Fa(
          {
            ...
            F: this.c("api_host") + "/" + this.c("api_routes").track,
            Ha: this.u.K,
            hd: h,
            ad: d,
          },
    ...
    e.prototype.fd = K(function (a, b, d) {
      c.isArray(b) || (b = [b]);
      var e = {};
      e[a] = b;
      this.m(e);
    ...
    e.prototype.vc = K(function (a, b, c) {
      var e = this.s(a),
        h = {};
      e === l
        ? ((h[a] = [b]), this.m(h))
    ...
    e.prototype.Vc = K(function (a, b, c) {
      ...
      if (e !== l) {
        var h = e.indexOf(b);
        -1 < h && (e.splice(h, 1), this.m({ Cd: e }));
        0 === e.length && this.Q(a);
      }
      return this.people.remove(a, b, c);
    });
    e.prototype.ud = K(function (a, b, d, e) {
      var h = c.extend({}, b || {});
      c.a(d, function (a, b) {
        a !== r && a !== l && (h[b] = a);
      });
    ...
    e.prototype.Hc = function (a, b) {
      ...
      if (e === l || e.Ca !== a || e.Ba !== b)
        (e = new u()), e.X(this, a, b), (this.kb[c] = e);
      return e;
    };
    e.prototype.eb = K(function (a, b) {
      "object" !== typeof a && (a = {});
      var b = b || {},
        d = b.event_name || "$mp_web_page_view",
        e = c.extend(c.info.Pc(), c.info.Y(), c.info.ub()),
        e = c.extend({}, e, a);
      return this.o(d, e);
    });
    ...
    e.prototype.nd = function (a) {
      c.g(a)
        ...
        : this.mb(a) || this.persistence.ed(a);
    };
    var Da = { persistent: m };
    e.prototype.m = function (a, b) {
      var d = da(b);
      d.persistent ? this.persistence.m(a, d.days) : c.extend(this.P, a);
    };
      ...
      d.persistent
        ...
        : ("undefined" === typeof b && (b = "None"),
          c.a(
            a,
            function (a, c) {
              if (!this.P.hasOwnProperty(c) || this.P[c] === b) this.P[c] = a;
            },
            this
          ));
    };
    e.prototype.Q = function (a, b) {
      b = da(b);
      b.persistent ? this.persistence.Q(a) : delete this.P[a];
    };
    ...
    e.prototype.Sa = function (a, b, c, e, h, g, j, i) {
      var k = this.L();
      if (a && k !== a) {
      ...
      a !== k &&
        a !== this.s("__alias") &&
        (this.Q("__alias"), this.m({ distinct_id: a }));
      this.U.Eb = m;
      this.people.sc(b, c, e, h, g, j, i);
      a !== k &&
        this.o(
          "$identify",
    ...
    e.prototype.$b = function (a) {
      if (c.e(a))
        c.extend(this.config, a),
          ...
          this.persistence && this.persistence.kc(this.config),
          (J = J || this.c("debug"));
    };
    ...
    e.prototype.pb = function (a) {
      var b = (this.config.hooks[a] || Ea).apply(this, L.call(arguments, 1));
      "undefined" === typeof b &&
    ...
    e.prototype.mb = function (a) {
      return c.Ib(z) || this.U.Bc || c.Ta(this.xa, a);
    };
    e.prototype.tc = function () {
      "localStorage" === this.c("opt_out_tracking_persistence_type") &&
        ...
        (!this.qa() &&
          ...
          this.Mb({ enable_persistence: D }),
        !this.Z() &&
          this.Z({ persistence_type: "cookie" }) &&
          this.Ya({ clear_persistence: D }),
        this.tb({ persistence_type: "cookie", enable_persistence: D }));
      if (this.Z()) this.ia({ clear_persistence: m });
      else if (
        !this.qa() &&
    ...
    e.prototype.ia = function (a) {
      ...
      !this.c("disable_persistence") &&
        ...
        this.persistence.ac(a);
      a ? this.bb() : this.oc && this.ab();
    };
    e.prototype.W = function (a, b) {
      ...
      return a(this.c("token"), {
        o: b.track,
        pd: b.track_event_name,
        qd: b.track_properties,
        Qb: b.persistence_type,
        Pb: b.cookie_prefix,
        vb: b.cookie_domain,
        wb: b.cookie_expiration,
        Ac: b.cross_site_cookie,
        xb: b.cross_subdomain_cookie,
        Yc: b.secure_cookie,
        Fb: b.ignore_dnt,
      });
    };
    ...
    e.prototype.l = function (a, b) {
      o.error.apply(o.error, arguments);
      try {
    ...
    e.prototype.init = e.prototype.Ua;
    e.prototype.reset = e.prototype.reset;
    e.prototype.disable = e.prototype.disable;
    e.prototype.time_event = e.prototype.nd;
    e.prototype.track = e.prototype.o;
    e.prototype.track_links = e.prototype.td;
    e.prototype.track_forms = e.prototype.sd;
    e.prototype.track_pageview = e.prototype.eb;
    e.prototype.register = e.prototype.m;
    e.prototype.register_once = e.prototype.w;
    e.prototype.unregister = e.prototype.Q;
    e.prototype.identify = e.prototype.Sa;
    e.prototype.alias = e.prototype.wc;
    e.prototype.name_tag = e.prototype.Qc;
    e.prototype.set_config = e.prototype.$b;
    e.prototype.get_config = e.prototype.c;
    e.prototype.get_property = e.prototype.s;
    e.prototype.get_distinct_id = e.prototype.L;
    e.prototype.toString = e.prototype.toString;
    e.prototype.opt_out_tracking = e.prototype.Ya;
    e.prototype.opt_in_tracking = e.prototype.Mb;
    e.prototype.has_opted_out_tracking = e.prototype.Z;
    e.prototype.has_opted_in_tracking = e.prototype.qa;
    e.prototype.clear_opt_in_out_tracking = e.prototype.tb;
    e.prototype.get_group = e.prototype.Hc;
    e.prototype.set_group = e.prototype.fd;
    e.prototype.add_group = e.prototype.vc;
    e.prototype.remove_group = e.prototype.Vc;
    e.prototype.track_with_groups = e.prototype.ud;
    e.prototype.start_batch_senders = e.prototype.ab;
    e.prototype.stop_batch_senders = e.prototype.bb;
    e.prototype.start_session_recording = e.prototype.dc;
    e.prototype.stop_session_recording = e.prototype.ld;
    e.prototype.get_session_recording_properties = e.prototype.Db;
    e.prototype.DEFAULT_API_ROUTES = A;
    q.prototype.properties = q.prototype.aa;
    q.prototype.update_search_keyword = q.prototype.lc;
    q.prototype.update_referrer_info = q.prototype.gb;
    q.prototype.get_cross_subdomain = q.prototype.Gc;
